...
*Set directory
cd "/home/max/github/mission_replication/data/source/Tables/"

*Table I

*Literacy
use "Literacy Argentina Brazil Paraguay.dta", clear
tabstat  literacy illiteracy, by (distmiss50) stat (n mea med sd min max) col(stat)

*Median Years of Schooling
use "Median Years of Schooling Brazil.dta", clear
tabstat edumedyr, by (distmiss50) stat (n mea sd min max) col(stat)

*Income
use "Income Brazil Paraguay.dta", clear
tabstat  lnincome, by (distmiss50) stat (n mea med sd min max) col(stat)

*Poverty
use "Poverty Argentina Paraguay.dta", clear
...
*Table IV
*Literacy
use "Placebo Literacy Income.dta", clear
...
*Panel A
*Brazil
use "Structural Transformation Brazil.dta", clear
...
*Argentina
use "Structural Transformation Argentina.dta", clear
...
*Paraguay
use "Structural Transformation Paraguay.dta", clear
...
*Table X
use "Industries Brazil.dta", clear
...
use "Pre-Colonial Population Density.dta", clear
...
*Paraguay
use "Culture Paraguay.dta", clear
